...
begin
  ...
  HexView.DataMap.AddMaskCheck(3, 'PBF_UTF8', '0x800', PBF_UTF8 and Data.GeneralPurposeBitFlag = PBF_UTF8);
  HexView.DataMap.AddMaskCheck(1, 'PBF_CRYPTED', '0x1', PBF_CRYPTED and Data.GeneralPurposeBitFlag = PBF_CRYPTED);
  HexView.DataMap.AddMaskSeparator;
  HexView.DataMap.AddMaskRadio(1, 'PBF_COMPRESS_NORMAL', '0x0', 6 and Data.GeneralPurposeBitFlag = PBF_COMPRESS_NORMAL);
  HexView.DataMap.AddMaskRadio(1, 'PBF_COMPRESS_MAXIMUM', '0x2', 6 and Data.GeneralPurposeBitFlag = PBF_COMPRESS_MAXIMUM);
  HexView.DataMap.AddMaskRadio(1, 'PBF_COMPRESS_FAST', '0x4', 6 and Data.GeneralPurposeBitFlag = PBF_COMPRESS_FAST);
  HexView.DataMap.AddMaskRadio(1, 'PBF_COMPRESS_SUPERFAST', '0x6', 6 and Data.GeneralPurposeBitFlag = PBF_COMPRESS_SUPERFAST);
  HexView.DataMap.AddMaskSeparator;
  HexView.DataMap.AddMaskCheck(1, 'PBF_DESCRIPTOR', '0x8', PBF_DESCRIPTOR and Data.GeneralPurposeBitFlag = PBF_DESCRIPTOR);
